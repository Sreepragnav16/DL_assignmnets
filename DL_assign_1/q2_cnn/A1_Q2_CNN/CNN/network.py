...
def adamGD(batch, num_classes, lr, dim, n_c, beta1, beta2, params, cost):
    ...
    for i in range(batch_size):
        ...
        grads, loss = conv(x, y, params, 2, 2, 2)
...
def train(num_classes = 7, lr = 0.001, beta1 = 0.9, beta2 = 0.99, img_dim = 128, img_depth = 3, f = 5, num_filt1 = 8, num_filt2 = 8, batch_size = 32, num_epochs = 7, save_path = 'my_params.pkl'):

    # training data
    X = extract_data('../HumanActionClassification', img_dim, m=800)
    y_dash = extract_labels('../HumanActionClassification', m=800)
    X-= int(np.mean(X))
    X/= int(np.std(X))
    ...
    f1, f2, w3, w4 = (num_filt1 ,img_depth,f,f), (num_filt2 ,num_filt1,f,f), (256,1568), (7, 256)
